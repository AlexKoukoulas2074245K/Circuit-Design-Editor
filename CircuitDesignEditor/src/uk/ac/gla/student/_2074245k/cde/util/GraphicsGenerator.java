...
/**
* The GraphicsGenerator class is heavily used in rendering operations. It is provided a Graphics2D object 
* (in reality either the Graphics2D or SVGGraphics2D objects will be passed) to its constructor, and 
* the respective methods will be polymorphically executed respectively.
* 
