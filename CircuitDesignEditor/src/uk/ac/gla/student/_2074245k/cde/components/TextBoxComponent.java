...
/**
* The TextBoxComponent class encapsulates the behaviour of the meta-notation text boxes, 
* which provide useful comments to diagrams. The TextBoxComponent class also inherits 
